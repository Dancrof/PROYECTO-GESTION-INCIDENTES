...
//        Widgets::create(['id' => '6', 'name' => 'side2']);
        ...
        Template::create(['id' => '1', 'variable' => '0', 'name' => 'Esta plantilla sirve para notificar al agente cuando se le asigna un ticket.', 'type' => '1', 'message' => '<div>Hola {!!$ticket_agent_name!!},<br /><br /><b>Ticket No:</b> {!!$ticket_number!!}<br />Ha sido asignado a usted por {!!$ticket_assigner!!} <br/> Por favor revise y responda en el ticket.<br /> Enlace: {!!$ticket_link!!}<br /><br />Gracias<br />Saludos cordiales,<br /> {!!$system_from!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '2', 'variable' => '1', 'name' => 'Esta plantilla sirve para enviar una notificación al cliente con un enlace para consultar el ticket sin necesidad de iniciar sesión en el sistema.', 'type' => '2', 'subject' => 'Consulta tu boleto', 'message' => '<div>Hola {!!$user!!},<br/><br/>Haga clic en el enlace de abajo para ver su ticket solicitado<br/> {!!$ticket_link_with_number!!}<br/><br/>Saludos cordiales,<br/> {!!$system_from!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '3', 'variable' => '0', 'name' => 'Esta plantilla sirve para notificar al cliente cuando el estado del ticket cambia a «cerrado».', 'type' => '3', 'message' => '<div>Hola,<br/><br/>Este mensaje se refiere a su ticket ID {!!$ticket_number!!}. Estamos cambiando el estado de este ticket a "Cerrado" ya que el problema parece estar resuelto.<br/><br/>Gracias<br/>Saludos cordiales,<br/> {!!$system_from!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '4', 'variable' => '0', 'name' => 'Esta plantilla sirve para notificar al cliente que el ticket se ha creado correctamente.', 'type' => '4', 'message' => '<div><span>Hola {!!$user!!}<br/><br/></span><span>Gracias por contactarnos. Esta es una respuesta automática que confirma la recepción de su ticket. Nuestro equipo se pondrá en contacto con usted lo antes posible. Al responder, asegúrese de mantener el ID del ticket en el asunto para que podamos rastrear sus respuestas.<br/><br/></span><span><b>ID del Ticket:</b> {!!$ticket_number!!} <br/><br/></span><span> {!!$department_sign!!}<br/></span>Puede ver el estado o actualizar este ticket en línea en: {!!$system_link!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '5', 'variable' => '0', 'name' => 'Esta plantilla sirve para notificar al agente sobre la creación de un nuevo ticket.', 'type' => '5', 'message' => '<div>Hola {!!$ticket_agent_name!!},<br/><br/>Nuevo ticket {!!$ticket_number!!}creado <br/><br/><b>De</b><br/><b>Nombre:</b> {!!$ticket_client_name!!}   <br/><b>Correo:</b> {!!$ticket_client_email!!}<br/><br/> {!!$content!!}<br/><br/>Saludos cordiales,<br/> {!!$system_from!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '6', 'variable' => '0', 'name' => 'Esta plantilla sirve para notificar al cliente sobre un nuevo ticket creado por un agente en su nombre.', 'type' => '6', 'message' => '<div> {!!$content!!}<br><br> {!!$agent_sign!!}<br><br>Puede ver el estado o actualizar este ticket en línea en: {!!$system_link!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '7', 'variable' => '1', 'name' => 'Esta plantilla sirve para notificar a un cliente no registrado sobre su nuevo registro al crear un nuevo ticket.', 'type' => '7', 'subject' => 'Confirmación de registro', 'message' => '<p>Hola {!!$user!!}, </p><p>Este correo electrónico confirma que ya está registrado en nuestro servicio de asistencia.</p><p><b>Correo Registrado:</b> {!!$email_address!!}</p><p><b>Contraseña:</b> {!!$user_password!!}</p><p>Puede visitar el helpdesk para explorar artículos y contactarnos en cualquier momento: {!!$system_link!!}</p><p>Gracias.</p><p>Saludos,</p><p> {!!$system_from!!} </p>', 'set_id' => '1']);
        Template::create(['id' => '8', 'variable' => '1', 'name' => 'Esta plantilla sirve para notificar a cualquier usuario sobre la opción de restablecer la contraseña.', 'type' => '8', 'subject' => 'Restablece tu contraseña', 'message' => 'Hola {!!$user!!},<br/><br/>Solicitó restablecer su contraseña. Para hacerlo, haga clic en este enlace:<br/><br/> {!!$password_reset_link!!}<br/><br/>Esto le permitirá cambiar su contraseña por una nueva.<br/><br/> Si no solicitó esto, no se preocupe, mantendremos su contraseña segura.<br/><br/>Gracias.<br/><br/>Saludos cordiales,<br/> {!!$system_from!!}', 'set_id' => '1']);
        Template::create(['id' => '9', 'variable' => '0', 'name' => 'Esta plantilla sirve para notificar al cliente cuando se ha respondido a su ticket.', 'type' => '9', 'message' => '<span></span><div><span></span><p> {!!$content!!}<br/></p><p> {!!$agent_sign!!} </p><p><b>Detalles del Ticket</b></p><p><b>ID del Ticket:</b> {!!$ticket_number!!}</p></div>', 'set_id' => '1']);
        Template::create(['id' => '10', 'variable' => '0', 'name' => 'Esta plantilla sirve para notificar al agente cuando el cliente responde a un ticket.', 'type' => '10', 'message' => '<div>Hola {!!$ticket_agent_name!!},<br/><b><br/></b>Se ha hecho una respuesta al ticket {!!$ticket_number!!}<br/><b><br/></b><b>De<br/></b><b>Nombre: </b>{!!$ticket_client_name!!}<br/><b>Correo: </b>{!!$ticket_client_email!!}<br/><b><br/></b> {!!$content!!}<br/><b><br/></b>Saludos cordiales,<br/> {!!$system_from!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '11', 'variable' => '1', 'name' => 'Esta plantilla sirve para notificar al cliente sobre el enlace de confirmación de registro.', 'type' => '11', 'subject' => 'Verifica tu dirección de correo electrónico', 'message' => '<p>Hola {!!$user!!}, </p><p>Este correo electrónico confirma que ya está registrado en nuestro servicio de asistencia.</p><p><b>Correo Registrado:</b> {!!$email_address!!}</p><p>Por favor haga clic en el enlace de abajo para activar su cuenta e iniciar sesión en el sistema {!!$password_reset_link!!}</p><p>Gracias.</p><p>Saludos cordiales,</p><p> {!!$system_from!!} </p>', 'set_id' => '1']);
        Template::create(['id' => '12', 'variable' => '1', 'name' => 'Esta plantilla sirve para notificar al equipo cuando se le asigna un ticket.', 'type' => '12', 'message' => '<div>Hola {!!$ticket_agent_name!!},<br /><br /><b>Ticket No:</b> {!!$ticket_number!!}<br />Ha sido asignado a su equipo: {!!$team!!} por {!!$ticket_assigner!!} <br /><br />Gracias<br />Saludos cordiales,<br />{!!$system_from!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '13', 'variable' => '1', 'name' => 'Esta plantilla sirve para notificar al cliente cuando se cambia la contraseña.', 'type' => '13', 'subject' => 'Verifica tu dirección de correo electrónico', 'message' => 'Hola {!!$user!!},<br /><br />Su contraseña ha sido cambiada exitosamente. Su nueva contraseña es: {!!$user_password!!}<br /><br />Gracias.<br /><br />Saludos cordiales,<br /> {!!$system_from!!}', 'set_id' => '1']);
        Template::create(['id' => '14', 'variable' => '1', 'name' => 'Esta plantilla sirve para notificar a los usuarios cuando se fusionan sus tickets.', 'type' => '14', 'subject' => 'Tus tickets se han fusionado.', 'message' => '<p>Hola {!!$user!!},<br />&nbsp;</p><p>Su(s) ticket(s) con número de ticket {!!$merged_ticket_numbers!!} han sido cerrados y fusionados con <a href="{!!$ticket_link!!}">{!!$ticket_number!!}</a>.&nbsp;</p><p>Posibles razones para fusionar tickets</p><ul><li>Los tickets son duplicados</li><li>Los tickets expresan el mismo problema</li><li>Otro miembro de su organización ha creado un ticket para el mismo problema</li></ul><p><a href="{!!$system_link!!}">Haga clic aquí</a> para iniciar sesión en su cuenta y ver sus tickets.</p><p>Saludos,</p><p>{!!$system_from!!}</p>', 'set_id' => '1']);
